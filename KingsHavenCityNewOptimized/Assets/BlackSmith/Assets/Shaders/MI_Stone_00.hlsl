...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(10.000000,3.500000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,1.000000,3.952775);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local10 = (Local8.rgb * ((MaterialFloat3)Material.PreshaderBuffer[2].w));
	MaterialFloat Local11 = dot(Local10,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local12 = lerp(Local10,((MaterialFloat3)Local11),Material.PreshaderBuffer[3].x);
	MaterialFloat3 Local13 = (Local12 * Material.PreshaderBuffer[5].xyz);
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 2);
	...
	MaterialFloat3 Local17 = (Local15.rgb * ((MaterialFloat3)Material.PreshaderBuffer[5].w));
	MaterialFloat Local18 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
