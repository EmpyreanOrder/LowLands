...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,13.928588,0.500000,0.000000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local15 = (Material.PreshaderBuffer[5].x * Local13.b);
	MaterialFloat Local16 = (Material.PreshaderBuffer[5].y * Local13.g);
	MaterialFloat Local17 = (Local13.r * Material.PreshaderBuffer[5].z);
