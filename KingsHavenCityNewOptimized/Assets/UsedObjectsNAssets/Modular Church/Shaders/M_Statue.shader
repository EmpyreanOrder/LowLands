Shader "Unreal/M_Statue"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Statue_01_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Statue_01_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Statue_01_RMA_UE", 2D ) = "white" {}
