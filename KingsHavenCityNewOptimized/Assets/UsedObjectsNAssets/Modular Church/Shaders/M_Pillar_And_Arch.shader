Shader "Unreal/M_Pillar_And_Arch"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Pillar_And_Arch_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Pillar_And_Arch_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Pillar_And_Arch_RMA_UE", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Pillar_And_Arch.hlsl"
