Shader "Unreal/M_Border_Wall"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Border_Wall_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Border_Wall_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Border_Wall_RMA_UE", 2D ) = "white" {}
