Shader "Unreal/M_Gothic_Bench"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Gothic_Bench_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Gothic_Bench_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Gothic_Bench_RMA_UE", 2D ) = "white" {}
