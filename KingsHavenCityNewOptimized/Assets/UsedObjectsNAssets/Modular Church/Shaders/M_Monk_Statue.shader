Shader "Unreal/M_Monk_Statue"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Monk_Statue_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Monk_Statue_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Monk_Statue_RMA_UE", 2D ) = "white" {}
