Shader "Unreal/M_Candlestick_Cross"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Candlestick_Cross_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Candlestick_Cross_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Candlestick_Cross_RMA_UE", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Candlestick_Cross.hlsl"
