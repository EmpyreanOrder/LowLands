Shader "Unreal/M_Circle_Window"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Circle_Window_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Circle_Window_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Circle_Window_RMA_UE", 2D ) = "white" {}
