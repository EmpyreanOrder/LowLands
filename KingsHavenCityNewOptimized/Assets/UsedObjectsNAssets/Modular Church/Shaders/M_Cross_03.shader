Shader "Unreal/M_Cross_03"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Cross_03_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Cross_03_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Cross_03_RMA_UE", 2D ) = "white" {}
