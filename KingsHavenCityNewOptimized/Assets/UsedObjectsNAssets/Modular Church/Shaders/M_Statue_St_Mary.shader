Shader "Unreal/M_Statue_St_Mary"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Statue_St_Mary_Colored_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Statue_St_Mary_Colored_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Statue_St_Mary_Colored_RMA_UE", 2D ) = "white" {}
