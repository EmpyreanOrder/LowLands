Shader "Unreal/M_High_Main_Doorway"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_High_Main_Doorway_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_High_Main_Doorway_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_High_Main_Doorway_RMA_UE", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_High_Main_Doorway.hlsl"
