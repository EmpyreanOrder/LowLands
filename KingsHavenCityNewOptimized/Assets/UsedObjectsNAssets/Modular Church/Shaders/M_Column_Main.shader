Shader "Unreal/M_Column_Main"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Column_Main_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Column_Main_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Column_Main_RMA_UE", 2D ) = "white" {}
