Shader "Unreal/M_Cross_01"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Cross_01_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Cross_01_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Cross_01_RMA_UE", 2D ) = "white" {}
