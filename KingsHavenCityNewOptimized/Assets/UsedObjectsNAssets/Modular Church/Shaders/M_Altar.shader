Shader "Unreal/M_Altar"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Altar_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Altar_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Altar_RMA_UE", 2D ) = "white" {}
