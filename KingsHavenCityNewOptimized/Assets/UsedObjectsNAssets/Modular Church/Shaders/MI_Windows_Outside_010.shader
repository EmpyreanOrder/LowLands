Shader "Unreal/MI_Windows_Outside_010"
{
    Properties
    {
		...
		Material_Texture2D_0( "Color", 2D ) = "white" {}
		Material_Texture2D_1( "T_Arch_01_Metallic", 2D ) = "white" {}
		Material_Texture2D_2( "Opacity_Roughness", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Windows_Outside_010.hlsl"
