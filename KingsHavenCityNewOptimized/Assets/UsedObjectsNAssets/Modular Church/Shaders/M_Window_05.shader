Shader "Unreal/M_Window_05"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Window_05_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Window_05_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Window_05_RMA_UE", 2D ) = "white" {}
