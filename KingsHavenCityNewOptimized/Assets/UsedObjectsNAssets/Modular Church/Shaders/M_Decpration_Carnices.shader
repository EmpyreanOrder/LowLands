Shader "Unreal/M_Decpration_Carnices"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Decpration_Carnices_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Decpration_Carnices_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Decpration_Carnices_RMA_UE", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Decpration_Carnices.hlsl"
