...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.025000,0.025000,0.025000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.025000,0.025000,0.025000,8.109198);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local6 = (((MaterialFloat3)Local3.a) * Material.PreshaderBuffer[5].xyz);
