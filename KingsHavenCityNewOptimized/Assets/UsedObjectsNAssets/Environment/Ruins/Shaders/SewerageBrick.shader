Shader "Unreal/SewerageBrick"
{
    Properties
    {
		...
		Material_Texture2D_0( "Normal2", 2D ) = "white" {}
		Material_Texture2D_1( "Normal", 2D ) = "white" {}
		Material_Texture2D_2( "vertex color mask", 2D ) = "white" {}
		Material_Texture2D_3( "Diffuse2", 2D ) = "white" {}
		Material_Texture2D_4( "Diffuse", 2D ) = "white" {}
		Material_Texture2D_5( "SRMH2", 2D ) = "white" {}
		Material_Texture2D_6( "SRMH", 2D ) = "white" {}
