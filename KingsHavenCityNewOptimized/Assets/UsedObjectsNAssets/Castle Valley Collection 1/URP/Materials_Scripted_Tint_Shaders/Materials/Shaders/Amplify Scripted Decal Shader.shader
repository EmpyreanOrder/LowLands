    ...
    SubShader
    {
        ...
        Pass
        {
			...
			)
			{
				...
				float2 uv_Color = texCoord0 * _Color_ST.xy + _Color_ST.zw;
				float4 tex2DNode11 = tex2D( _Color, uv_Color );
				float4 blendOpSrc17 = tex2DNode11;
				float4 blendOpDest17 = ( GlobalTint * saturate( ( GlobalContrast + tex2DNode11.r ) ) );
				
				float2 uv_NormalMap = texCoord0 * _NormalMap_ST.xy + _NormalMap_ST.zw;
				

				surfaceDescription.BaseColor = ( saturate( 2.0f*blendOpDest17*blendOpSrc17 + blendOpDest17*blendOpDest17*(1.0f - 2.0f*blendOpSrc17) )).rgb;
				surfaceDescription.Alpha = tex2DNode11.a;
				surfaceDescription.NormalTS = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f );
				surfaceDescription.NormalAlpha = tex2DNode11.a;
        ...
        Pass
        {
			...
			)
			{
				...
				float2 uv_Color = packedInput.texCoord0.xy * _Color_ST.xy + _Color_ST.zw;
				float4 tex2DNode11 = tex2D( _Color, uv_Color );
				float4 blendOpSrc17 = tex2DNode11;
				float4 blendOpDest17 = ( GlobalTint * saturate( ( GlobalContrast + tex2DNode11.r ) ) );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 BaseColor = ( saturate( 2.0f*blendOpDest17*blendOpSrc17 + blendOpDest17*blendOpDest17*(1.0f - 2.0f*blendOpSrc17) )).rgb;
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.SamplerNode;11;-949.0392,-300.9352;Inherit;True;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;-1;None;464ee7c4d3466b446bfc0d037e48246c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;12;-901.3552,-472.8953;Inherit;False;Global;GlobalContrast;Global Contrast;11;0;Create;True;0;0;0;False;0;False;0;-0.12;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;13;-627.7554,-400.8949;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;14;-507.7554,-394.4947;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;15;-707.2388,-619.6927;Inherit;False;Global;GlobalTint;Global Tint;10;0;Create;True;0;0;0;False;0;False;0.4811321,0.4811321,0.4811321,0;0.4784314,0.8117647,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-360.5562,-444.0958;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;17;-179.8716,-304.6906;Inherit;False;SoftLight;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;10;-670.0959,-36.64544;Inherit;True;Property;_NormalMap;Normal Map;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;2;1;11;4
WireConnection;2;2;10;0
WireConnection;2;3;11;4
ASEEND*/
//CHKSM=940641D1C57F3BD6D7086652631079E0A5549E8E