Shader "Unreal/MI_Fabric_Tarp_Stained_01_D"
{
    Properties
    {
		...
		Material_Texture2D_3( "ARD", 2D ) = "white" {}
		Material_Texture2D_4( "T_Floor_Brick_Rough_01_ORDp", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Fabric_Tarp_Stained_01_D.hlsl"
