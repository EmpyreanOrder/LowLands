...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.043386,0.062500,0.004269,0.200000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,0.000000,0.850000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,-10.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local14 = (Local8.a * Material.PreshaderBuffer[3].w);
	MaterialFloat3 Local51 = (Local13 * ((MaterialFloat3)Material.PreshaderBuffer[6].y));
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local51,Material.PreshaderBuffer[6].z);
	PixelMaterialInputs.AmbientOcclusion = 0.00000000;
