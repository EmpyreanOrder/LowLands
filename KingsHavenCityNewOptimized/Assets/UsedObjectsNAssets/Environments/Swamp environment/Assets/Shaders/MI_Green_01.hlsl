...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.354167,0.330255,0.288482,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[4] = float4(0.200000,0.042452,0.078125,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,-1.153596,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = (Material.PreshaderBuffer[1].xyz * Local3.rgb);
	...
	PixelMaterialInputs.OpacityMask = Local7.rgb;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Material.PreshaderBuffer[4].yzw,Material.PreshaderBuffer[5].x);
	PixelMaterialInputs.AmbientOcclusion = 1.00000000;
	PixelMaterialInputs.Refraction = 0;
	PixelMaterialInputs.PixelDepthOffset = Material.PreshaderBuffer[5].y;
