Shader "Unreal/MI_Plaster"
{
    Properties
    {
		...
		Material_Texture2D_2( "T_Noise2_Mask", 2D ) = "white" {}
		Material_Texture2D_3( "DirtMask", 2D ) = "white" {}
		Material_Texture2D_4( "DirtMask (UVMAP2)", 2D ) = "white" {}
		Material_Texture2D_5( "metalic", 2D ) = "white" {}
		Material_Texture2D_6( "roughness", 2D ) = "white" {}
