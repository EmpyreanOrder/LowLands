...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.093750,0.093750,0.093750,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.093750,0.093750,0.093750,0.700000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.010000,0.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local5 = (MaterialFloat2(Local3.rgb.r,Local3.rgb.g) * ((MaterialFloat2)Material.PreshaderBuffer[1].y));
	...
	MaterialFloat3 Local11 = lerp(Local8.rgb,((MaterialFloat3)Local10),Material.PreshaderBuffer[2].w);
	MaterialFloat3 Local12 = (Local11 * Material.PreshaderBuffer[4].xyz);
	...
	MaterialFloat4 Local15 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 1);
	MaterialFloat Local17 = lerp(Material.PreshaderBuffer[5].x,Material.PreshaderBuffer[4].w,Local15.rgb.g);
	...
	PixelMaterialInputs.Metallic = Local15.rgb.b;
	...
	PixelMaterialInputs.AmbientOcclusion = Local15.rgb.r;
