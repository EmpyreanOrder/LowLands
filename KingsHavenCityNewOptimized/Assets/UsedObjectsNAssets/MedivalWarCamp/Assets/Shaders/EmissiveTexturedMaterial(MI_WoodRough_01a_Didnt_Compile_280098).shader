Shader "Unreal/EmissiveTexturedMaterial(MI_WoodRough_01a_Didnt_Compile_280098)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(MI_WoodRough_01a_Didnt_Compile_280098).hlsl"
