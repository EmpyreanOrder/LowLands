Shader "Unreal/MI_WoodCarvingTrim_01b_1"
{
    Properties
    {
		...
		Material_Texture2D_0( "Base Layer Normal Map", 2D ) = "white" {}
		Material_Texture2D_1( "Base Layer ORM Map", 2D ) = "white" {}
		Material_Texture2D_2( "Base Layer Albedo Map", 2D ) = "white" {}
		Material_Texture2D_3( "GrayscaleMask", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_WoodCarvingTrim_01b_1.hlsl"
