...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.200000,0.200000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.200000,0.200000,0.200000,0.200000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.100000,0.100000,0.100000,0.100000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(-0.100000,-0.100000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[10] = float4(1.000000,0.488000,1.210745,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1.000000,0.000000,0.488000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.000000,1.000000,1.000000,1.210745);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.500000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.000000,0.000000,1.000000,0.536000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local16 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[9].xyz,Material.PreshaderBuffer[8].y);
	...
	MaterialFloat Local25 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 3);
	...
	MaterialFloat Local28 = lerp(Material.PreshaderBuffer[15].w,Material.PreshaderBuffer[15].z,Local26.g.r);
	MaterialFloat3 Local29 = lerp(Material.PreshaderBuffer[16].yzw,((MaterialFloat3)Material.PreshaderBuffer[16].x),Local28);
