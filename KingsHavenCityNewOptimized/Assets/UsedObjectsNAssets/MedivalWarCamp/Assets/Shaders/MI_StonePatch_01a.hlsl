...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(405.550049,405.550049,-405.550049,-0.002466);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,76.461906,76.461906,-76.461906);//(Unknown)
	Material.PreshaderBuffer[4] = float4(-0.013078,1.000000,229.404633,229.404633);//(Unknown)
	Material.PreshaderBuffer[5] = float4(-229.404633,-0.004359,1.000000,86.282539);//(Unknown)
	Material.PreshaderBuffer[6] = float4(86.282539,-86.282539,-0.011590,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1.000000,100.046082,50.023041,-3.581267);//(Unknown)
	Material.PreshaderBuffer[8] = float4(-53.604309,0.300000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[13] = float4(0.502849,1.000000,1.000000,0.150000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.364583,0.364583,0.364583,1.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(0.364583,0.364583,0.364583,1.000000);//(Unknown)
	Material.PreshaderBuffer[17] = float4(1.000000,0.000000,1.000000,0.150000);//(Unknown)
	...
	Material.PreshaderBuffer[26] = float4(1.000000,0.500000,-0.100000,0.500000);//(Unknown)
	Material.PreshaderBuffer[27] = float4(0.000000,0.500000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[28] = float4(1.000000,0.184000,2.000000,-1.000000);//(Unknown)
	Material.PreshaderBuffer[29] = float4(0.000000,1.000000,0.944000,1.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local68 = lerp(MaterialFloat3(Local44,Local43.b),MaterialFloat3(Local63,Local62.b),Local66.rgb.r);
	...
	MaterialFloat3 Local88 = lerp(Local68,MaterialFloat3(Local87,Local86.b),Local66.rgb.b);
	...
	MaterialFloat3 Local120 = lerp(Local88,MaterialFloat3(Local107,Local106.b),Local119.rr.x);
	...
	MaterialFloat3 Local196 = lerp(Local161,Local195,Local66.rgb.r);
	...
	MaterialFloat3 Local231 = lerp(Local196,Local230,Local66.rgb.b);
	...
	MaterialFloat3 Local266 = lerp(Local231,Local265,Local119.rr.x);
	...
	MaterialFloat Local269 = lerp(Local267,Local268,Local66.rgb.r);
	MaterialFloat Local270 = (Local207.r * Material.PreshaderBuffer[26].w);
	MaterialFloat Local271 = lerp(Local269,Local270,Local66.rgb.b);
	MaterialFloat Local272 = lerp(Local271,Material.PreshaderBuffer[27].z,Local119.rr.x);
	...
	MaterialFloat Local279 = lerp(Local275.r,Local278.r,Local66.rgb.r);
	...
	MaterialFloat Local283 = lerp(Local279,Local282.r,Local66.rgb.b);
	...
	MaterialFloat Local287 = lerp(Local283,Local286.r,Local119.rr.x);
	MaterialFloat Local288 = lerp(Local159,Local192,Local66.rgb.r);
	MaterialFloat Local289 = lerp(Local288,Local227,Local66.rgb.b);
	MaterialFloat Local290 = lerp(Local289,Local262,Local119.rr.x);
