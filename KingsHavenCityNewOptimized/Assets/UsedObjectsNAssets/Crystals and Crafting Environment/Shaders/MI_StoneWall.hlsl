...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.000000,2.100000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(0.000000,1.600000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1.400000,0.600000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1.000000,1.000000,0.100000,1.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.600000,-0.600000,2.400000,-1.400000);//(Unknown)
	...
	Material.PreshaderBuffer[16] = float4(1.000000,1.000000,1.000000,0.740000);//(Unknown)
	...
	Material.PreshaderBuffer[24] = float4(1.000000,1.000000,1.000000,0.800000);//(Unknown)
	...
	Material.PreshaderBuffer[28] = float4(0.900000,0.000000,0.000000,0.000000);//(Unknown)
