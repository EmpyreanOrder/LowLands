...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,1.000000,1.500000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(-0.500000,7.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local10 = lerp(Local8,((MaterialFloat3)Local9),Material.PreshaderBuffer[4].x);
	MaterialFloat3 Local11 = (Local6.rgb * ((MaterialFloat3)Material.PreshaderBuffer[4].y));
