Shader "Unreal/MI_Rock"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Rockdetail_N", 2D ) = "white" {}
		Material_Texture2D_1( "Normal", 2D ) = "white" {}
		Material_Texture2D_2( "T_Moss_02_BC", 2D ) = "white" {}
		Material_Texture2D_3( "BaseColor", 2D ) = "white" {}
		Material_Texture2D_4( "T_Rock_O", 2D ) = "white" {}
		Material_Texture2D_5( "ORM", 2D ) = "white" {}
		Material_Texture2D_6( "T_Moss_Orm", 2D ) = "white" {}
