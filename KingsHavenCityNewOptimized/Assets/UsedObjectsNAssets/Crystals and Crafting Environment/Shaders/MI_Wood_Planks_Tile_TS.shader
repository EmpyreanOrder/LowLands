Shader "Unreal/MI_Wood_Planks_Tile_TS"
{
    Properties
    {
		...
		Material_Texture2D_2( "Albedo Map", 2D ) = "white" {}
		Material_Texture2D_3( "AORM Map", 2D ) = "white" {}
		Material_Texture2D_4( "OM", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Wood_Planks_Tile_TS.hlsl"
