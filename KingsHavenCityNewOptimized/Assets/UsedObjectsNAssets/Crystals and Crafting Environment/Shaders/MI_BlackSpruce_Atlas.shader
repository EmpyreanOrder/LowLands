Shader "Unreal/MI_BlackSpruce_Atlas"
{
    Properties
    {
		...
		Material_Texture2D_2( "T_Noise01", 2D ) = "white" {}
		Material_Texture2D_3( "Mask", 2D ) = "white" {}
		Material_Texture2D_4( "Good64x64TilingNoiseHighFreq", 2D ) = "white" {}
		Material_Texture2D_5( "WindTurblenceVectorAndGustMagnitude", 2D ) = "white" {}
		Material_Texture2D_6( "T_WindNoise", 2D ) = "white" {}
		Material_Texture2D_7( "Position and Index Texture", 2D ) = "white" {}
		Material_Texture2D_8( "Position and Index Texture", 2D ) = "white" {}
		Material_Texture2D_9( "X-Vector And X-Extent Texture", 2D ) = "white" {}
		Material_Texture2D_10( "WindTurbulenceVectorAndGustMagnitude", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_BlackSpruce_Atlas.hlsl"
