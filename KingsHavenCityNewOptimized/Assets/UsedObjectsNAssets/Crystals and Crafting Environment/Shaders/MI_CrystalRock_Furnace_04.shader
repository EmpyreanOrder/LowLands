Shader "Unreal/MI_CrystalRock_Furnace_04"
{
    Properties
    {
		...
		Material_Texture2D_6( "Albedo Map (B)", 2D ) = "white" {}
		Material_Texture2D_7( "Albedo Map (R)", 2D ) = "white" {}
		Material_Texture2D_8( "Albedo Map", 2D ) = "white" {}
		Material_Texture2D_9( "AORM Map (B)", 2D ) = "white" {}
		Material_Texture2D_10( "AORM Map (R)", 2D ) = "white" {}
		Material_Texture2D_11( "AORM Map", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_CrystalRock_Furnace_04.hlsl"
