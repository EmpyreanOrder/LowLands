Shader "Unreal/MI_Cliff_01a"
{
    Properties
    {
		...
		Material_Texture2D_0( "NAO", 2D ) = "white" {}
		Material_Texture2D_1( "Unique NAOC", 2D ) = "white" {}
		Material_Texture2D_2( "BCR", 2D ) = "white" {}
		Material_Texture2D_3( "Macro Detail BCR (WAT)", 2D ) = "white" {}
		Material_Texture2D_4( "Color Variation", 2D ) = "white" {}
