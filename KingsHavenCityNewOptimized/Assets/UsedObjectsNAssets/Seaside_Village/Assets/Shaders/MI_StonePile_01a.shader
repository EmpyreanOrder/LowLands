Shader "Unreal/MI_StonePile_01a"
{
    Properties
    {
		...
		Material_Texture2D_2( "Macro Detail BCR (WAT)", 2D ) = "white" {}
		Material_Texture2D_3( "Color Variation", 2D ) = "white" {}
