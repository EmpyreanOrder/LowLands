Shader "Unreal/MI_DryBranches_01a"
{
    Properties
    {
		...
		Material_Texture2D_0( "NAOM", 2D ) = "white" {}
		Material_Texture2D_1( "BCR", 2D ) = "white" {}
		Material_Texture2D_2( "Color Variation", 2D ) = "white" {}
		Material_Texture2D_3( "CA_EnvironmentsColorVariations", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_DryBranches_01a.hlsl"
