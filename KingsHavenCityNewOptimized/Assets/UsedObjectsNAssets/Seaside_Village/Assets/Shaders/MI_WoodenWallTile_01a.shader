Shader "Unreal/MI_WoodenWallTile_01a"
{
    Properties
    {
		...
		Material_Texture2D_2( "Aging Texture (WAT)", 2D ) = "white" {}
		Material_Texture2D_3( "Noise For DFAO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_WoodenWallTile_01a.hlsl"
