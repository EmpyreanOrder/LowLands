...
Shader "Terrain"
{
   ...
   SubShader
   {
            Tags {"RenderType" = "Opaque" "Queue" = "Geometry+100" "IgnoreProjector" = "False"  "TerrainCompatible" = "true" "SplatCount" = "20"}
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/Terrain_Base-1026459662"
   Fallback "Hidden/Terrain_Base-1026459662"
