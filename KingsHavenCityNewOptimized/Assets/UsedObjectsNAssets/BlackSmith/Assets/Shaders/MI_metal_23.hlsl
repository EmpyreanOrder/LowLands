...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[27] = float4(0.000000,0.000000,0.500000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[33] = float4(0.000000,0.000000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[48] = float4(0.000000,0.650000,0.000000,2.000000);//(Unknown)
