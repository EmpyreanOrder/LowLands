...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[40] = float4(0.916667,0.875790,0.816406,0.891211);//(Unknown)
	Material.PreshaderBuffer[41] = float4(2.250602,0.000000,0.000000,0.000000);//(Unknown)
