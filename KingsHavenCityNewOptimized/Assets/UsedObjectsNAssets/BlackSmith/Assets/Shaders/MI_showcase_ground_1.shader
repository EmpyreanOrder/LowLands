Shader "Unreal/MI_showcase_ground_1"
{
    Properties
    {
		...
		Material_Texture2D_1( "Grunge_channel_Gv", 2D ) = "white" {}
		Material_Texture2D_2( "1_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_3( "2_Masks (Occ,Rough,Met)", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_showcase_ground_1.hlsl"
