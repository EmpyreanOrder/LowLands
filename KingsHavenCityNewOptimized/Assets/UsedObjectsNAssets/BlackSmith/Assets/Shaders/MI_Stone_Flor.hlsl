...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,0.250000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.614383,-1.000000,3.500000,0.500000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local13 = lerp(Local11,((MaterialFloat3)Local12),Material.PreshaderBuffer[5].x);
	...
	MaterialFloat Local17 = (Local15.b * Material.PreshaderBuffer[5].y);
	MaterialFloat Local18 = (Local15.g * Material.PreshaderBuffer[5].z);
	MaterialFloat Local19 = (Local15.r * Material.PreshaderBuffer[5].w);
