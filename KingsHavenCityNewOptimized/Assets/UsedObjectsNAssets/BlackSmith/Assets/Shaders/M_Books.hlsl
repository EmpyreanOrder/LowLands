...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.700000,-1.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local7 = lerp(Local5,((MaterialFloat3)Local6),Material.PreshaderBuffer[2].y);
