Shader "Unreal/MI_cannon_1"
{
    Properties
    {
		...
		Material_Texture2D_5( "Grunge_channel_Gv", 2D ) = "white" {}
		Material_Texture2D_6( "1_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_7( "moss_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_8( "2_Masks (Occ,Rough,Met)", 2D ) = "white" {}
		Material_Texture2D_9( "moss_Mask", 2D ) = "white" {}
