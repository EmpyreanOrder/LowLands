...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,5.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(5.000000,5.000000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[11] = float4(1.000000,1.000000,1.000000,5.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,-0.328282,10.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.000000,0.671718,0.328282,5.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(1.000000,0.232000,1.232000,-0.232000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(2.000000,-1.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[30] = float4(0.000000,0.000000,0.500000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[33] = float4(0.000000,0.000000,1.000000,0.168000);//(Unknown)
	...
	Material.PreshaderBuffer[40] = float4(0.916667,0.875790,0.816406,2.000000);//(Unknown)
	Material.PreshaderBuffer[41] = float4(3.000000,0.000000,0.000000,0.000000);//(Unknown)
