...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,0.323583);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,1.000000,0.650000,0.500000);//(Unknown)
}
