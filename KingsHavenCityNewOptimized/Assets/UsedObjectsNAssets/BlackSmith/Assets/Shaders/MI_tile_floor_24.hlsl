...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,8.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(8.000000,8.000000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[11] = float4(1.000000,1.000000,1.000000,8.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,-0.290772,6.709434,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.000000,0.709228,0.290772,8.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.200000,0.152607,1.152607,-0.152607);//(Unknown)
	Material.PreshaderBuffer[15] = float4(1.050208,8.000000,1.000000,0.856000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(1.856000,-0.856000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[27] = float4(0.000000,0.000000,0.750000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[30] = float4(0.000000,0.000000,0.350000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[33] = float4(0.000000,0.000000,0.168604,0.168000);//(Unknown)
	...
	Material.PreshaderBuffer[36] = float4(0.000000,0.000000,0.070000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[40] = float4(0.916667,0.875790,0.816406,1.000000);//(Unknown)
	Material.PreshaderBuffer[41] = float4(2.000000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[48] = float4(0.000000,0.100000,0.000000,2.027062);//(Unknown)
