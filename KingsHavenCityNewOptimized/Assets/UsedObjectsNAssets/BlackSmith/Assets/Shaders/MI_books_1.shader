Shader "Unreal/MI_books_1"
{
    Properties
    {
		...
		Material_Texture2D_4( "Grunge_channel_Gv", 2D ) = "white" {}
		Material_Texture2D_5( "1_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_6( "Base_maskR_channel", 2D ) = "white" {}
		Material_Texture2D_7( "2_Masks (Occ,Rough,Met)", 2D ) = "white" {}
		Material_Texture2D_8( "Occ,Rough,Met_maskR", 2D ) = "white" {}
