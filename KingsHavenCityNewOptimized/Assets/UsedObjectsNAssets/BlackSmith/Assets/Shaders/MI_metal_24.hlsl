...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[12] = float4(1.000000,0.796550,0.360000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.000000,1.796550,-0.796550,10.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(1.000000,4.600000,5.600000,-4.600000);//(Unknown)
	...
	Material.PreshaderBuffer[28] = float4(0.000000,0.000000,0.324000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[31] = float4(0.000000,0.000000,0.200000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[34] = float4(0.000000,0.000000,0.776000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[52] = float4(1.000000,0.000000,0.650000,0.000000);//(Unknown)
	Material.PreshaderBuffer[53] = float4(2.000000,0.000000,2.000000,0.000000);//(Unknown)
