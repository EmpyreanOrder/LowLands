Shader "Unreal/MI_bark_1"
{
    Properties
    {
		...
		Material_Texture2D_7( "Normal_mask", 2D ) = "white" {}
		Material_Texture2D_8( "Grunge_channel_Gv", 2D ) = "white" {}
		Material_Texture2D_9( "1_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_10( "Base_maskR_channel", 2D ) = "white" {}
		Material_Texture2D_11( "Base_Texture_maskG", 2D ) = "white" {}
		Material_Texture2D_12( "Base_Texture_maskB", 2D ) = "white" {}
		Material_Texture2D_13( "Base_maskA_channel", 2D ) = "white" {}
		Material_Texture2D_14( "2_Masks (Occ,Rough,Met)", 2D ) = "white" {}
		Material_Texture2D_15( "Occ,Rough,Met_maskR", 2D ) = "white" {}
		Material_Texture2D_16( "Occ,Rough,Met_maskG", 2D ) = "white" {}
		Material_Texture2D_17( "Occ,Rough,Met_maskB", 2D ) = "white" {}
		Material_Texture2D_18( "Occ,Rough,Met_maskA", 2D ) = "white" {}
