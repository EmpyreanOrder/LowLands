Shader "Unreal/MI_showcase_glass_1"
{
    Properties
    {
		...
		Material_Texture2D_1( "Base_mask_R", 2D ) = "white" {}
		Material_Texture2D_2( "Base Channel Mask Texture", 2D ) = "white" {}
		Material_Texture2D_3( "Base_mask_G", 2D ) = "white" {}
		Material_Texture2D_4( "Base_mask_B", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_showcase_glass_1.hlsl"
