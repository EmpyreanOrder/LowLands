...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[12] = float4(0.100000,-0.658585,2.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.000000,0.341415,0.658585,6.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(1.000000,1.000000,2.000000,-1.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(1.000000,6.000000,1.000000,0.856000);//(Unknown)
	...
	Material.PreshaderBuffer[29] = float4(0.751790,0.970486,0.765240,1.000000);//(Unknown)
	Material.PreshaderBuffer[30] = float4(0.000000,0.000000,0.200000,0.000000);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.751790,0.970486,0.765240,0.000000);//(Unknown)
	Material.PreshaderBuffer[32] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[33] = float4(0.000000,0.000000,0.600604,0.168000);//(Unknown)
	...
	Material.PreshaderBuffer[47] = float4(0.150000,1.000000,0.000000,0.120000);//(Unknown)
	Material.PreshaderBuffer[48] = float4(0.000000,1.000000,0.000000,2.000000);//(Unknown)
