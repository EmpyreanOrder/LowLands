...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[14] = float4(2.000000,-1.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(2.000000,-1.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(2.000000,-1.000000,0.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[20] = float4(0.000000,0.000000,0.500000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[23] = float4(0.000000,0.000000,0.500000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[26] = float4(0.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[27] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[28] = float4(0.000000,0.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[29] = float4(1.000000,0.150000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[30] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.000000,1.000000,1.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local49 = lerp(Material.PreshaderBuffer[14].y,Material.PreshaderBuffer[14].x,Local35.g);
	MaterialFloat Local50 = saturate(Local49);
	MaterialFloat Local51 = (Local50.r * Material.PreshaderBuffer[14].z);
	MaterialFloat Local52 = saturate(Local51);
	MaterialFloat3 Local53 = lerp(Local48,((MaterialFloat3)1.00000000),Local52);
	MaterialFloat Local54 = lerp(Material.PreshaderBuffer[15].y,Material.PreshaderBuffer[15].x,Local35.b);
	MaterialFloat Local55 = saturate(Local54);
	MaterialFloat Local56 = (Local55.r * Material.PreshaderBuffer[15].z);
	MaterialFloat Local57 = saturate(Local56);
	MaterialFloat3 Local58 = lerp(Local53,((MaterialFloat3)1.00000000),Local57);
	MaterialFloat Local59 = lerp(Material.PreshaderBuffer[16].y,Material.PreshaderBuffer[16].x,Local35.a);
	MaterialFloat Local60 = saturate(Local59);
	MaterialFloat Local61 = (Local60.r * Material.PreshaderBuffer[16].z);
	MaterialFloat Local62 = saturate(Local61);
	MaterialFloat3 Local63 = lerp(Local58,((MaterialFloat3)1.00000000),Local62);
	MaterialFloat4 Local64 = Parameters.VertexColor;
	MaterialFloat Local65 = DERIV_BASE_VALUE(Local64).g;
	MaterialFloat Local66 = (DERIV_BASE_VALUE(Local65) * Material.PreshaderBuffer[17].x);
	MaterialFloat2 Local67 = (((MaterialFloat2)Material.PreshaderBuffer[17].y) * DERIV_BASE_VALUE(Local0));
	MaterialFloat Local68 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local67), 4);
	MaterialFloat4 Local69 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local67),View.MaterialTextureMipBias));
	MaterialFloat Local70 = MaterialStoreTexSample(Parameters, Local69, 4);
	MaterialFloat3 Local71 = (Local69.rgb * ((MaterialFloat3)Material.PreshaderBuffer[17].z));
	MaterialFloat3 Local72 = (((MaterialFloat3)DERIV_BASE_VALUE(Local65)) + Local71);
	MaterialFloat3 Local73 = (((MaterialFloat3)DERIV_BASE_VALUE(Local66)) * Local72);
	MaterialFloat Local74 = lerp(Material.PreshaderBuffer[18].x,Material.PreshaderBuffer[17].w,Local73.x);
	MaterialFloat Local75 = saturate(Local74);
	MaterialFloat Local76 = saturate(Local75.r);
	...
	MaterialFloat Local77 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 0);
	MaterialFloat4 Local78 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_5,GetMaterialSharedSampler(samplerMaterial_Texture2D_5,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7)));
	MaterialFloat Local79 = MaterialStoreTexSample(Parameters, Local78, 0);
	MaterialFloat3 Local80 = (Local78.rgb * ((MaterialFloat3)Material.PreshaderBuffer[20].z));
	MaterialFloat Local81 = dot(Local80,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local82 = lerp(Local80,((MaterialFloat3)Local81),Material.PreshaderBuffer[20].w);
	MaterialFloat3 Local83 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000)),Material.PreshaderBuffer[20].y),((MaterialFloat3)0.00000000),Local82);
	MaterialFloat3 Local84 = (Local83 + Local82);
	MaterialFloat3 Local85 = (Material.PreshaderBuffer[21].xyz * Local84);
	MaterialFloat Local86 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local25), 0);
	MaterialFloat4 Local87 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_6,GetMaterialSharedSampler(samplerMaterial_Texture2D_6,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local25)));
	MaterialFloat Local88 = MaterialStoreTexSample(Parameters, Local87, 0);
	MaterialFloat3 Local89 = (Local87.rgb * ((MaterialFloat3)Material.PreshaderBuffer[23].z));
	MaterialFloat Local90 = dot(Local89,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local91 = lerp(Local89,((MaterialFloat3)Local90),Material.PreshaderBuffer[23].w);
	MaterialFloat3 Local92 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000)),Material.PreshaderBuffer[23].y),((MaterialFloat3)0.00000000),Local91);
	MaterialFloat3 Local93 = (Local92 + Local91);
	MaterialFloat3 Local94 = (Material.PreshaderBuffer[24].xyz * Local93);
	MaterialFloat3 Local95 = lerp(Local85,Local94,Local47);
	MaterialFloat3 Local96 = lerp(Local95,((MaterialFloat3)1.00000000),Local52);
	MaterialFloat3 Local97 = lerp(Local96,((MaterialFloat3)1.00000000),Local57);
	MaterialFloat3 Local98 = lerp(Local97,((MaterialFloat3)1.00000000),Local62);
	MaterialFloat3 Local99 = (Local98 * Material.PreshaderBuffer[27].xyz);
	MaterialFloat3 Local100 = lerp(Local99,Material.PreshaderBuffer[28].xyz,Material.PreshaderBuffer[27].w);
	MaterialFloat Local101 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 1);
	MaterialFloat4 Local102 = Texture2DSample(Material_Texture2D_7,GetMaterialSharedSampler(samplerMaterial_Texture2D_7,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7));
	MaterialFloat Local103 = MaterialStoreTexSample(Parameters, Local102, 1);
	MaterialFloat Local104 = (Local102.b * Material.PreshaderBuffer[28].w);
	MaterialFloat Local105 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local25), 1);
	MaterialFloat4 Local106 = Texture2DSample(Material_Texture2D_8,GetMaterialSharedSampler(samplerMaterial_Texture2D_8,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local25));
	MaterialFloat Local107 = MaterialStoreTexSample(Parameters, Local106, 1);
	MaterialFloat Local108 = (Local106.b * Material.PreshaderBuffer[29].x);
	MaterialFloat Local109 = lerp(Local104,Local108,Local47);
	MaterialFloat Local110 = lerp(Local109,1.00000000,Local52);
	MaterialFloat Local111 = lerp(Local110,1.00000000,Local57);
	MaterialFloat Local112 = lerp(Local111,1.00000000,Local62);
	MaterialFloat Local113 = lerp(Material.PreshaderBuffer[29].w,Material.PreshaderBuffer[29].z,Local102.g);
	MaterialFloat Local114 = lerp(Material.PreshaderBuffer[30].y,Material.PreshaderBuffer[30].x,Local106.g);
	MaterialFloat Local115 = lerp(Local113,Local114,Local47);
	MaterialFloat Local116 = lerp(Local115,1.00000000,Local52);
	MaterialFloat Local117 = lerp(Local116,1.00000000,Local57);
	MaterialFloat Local118 = lerp(Local117,1.00000000,Local62);
	MaterialFloat Local119 = lerp(Local78.a,1.00000000,0.50000000);
	MaterialFloat Local120 = (Local119 * Material.PreshaderBuffer[30].z);
	MaterialFloat3 Local121 = (Local98 * ((MaterialFloat3)Material.PreshaderBuffer[30].w));
	MaterialFloat Local122 = PositiveClampedPow(Local102.r,Material.PreshaderBuffer[31].y);
	MaterialFloat Local123 = PositiveClampedPow(Local106.r,Material.PreshaderBuffer[31].z);
	MaterialFloat Local124 = lerp(Local122,Local123,Local47);
	MaterialFloat Local125 = lerp(Local124,1.00000000,Local52);
	MaterialFloat Local126 = lerp(Local125,1.00000000,Local57);
	MaterialFloat Local127 = lerp(Local126,1.00000000,Local62);

	PixelMaterialInputs.EmissiveColor = Local100;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local120;
	PixelMaterialInputs.BaseColor = Local98;
	PixelMaterialInputs.Metallic = Local112;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[29].y;
	PixelMaterialInputs.Roughness = Local118;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local63;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local121,Material.PreshaderBuffer[31].x);
