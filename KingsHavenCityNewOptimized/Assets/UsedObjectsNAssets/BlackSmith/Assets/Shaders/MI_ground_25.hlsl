...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[12] = float4(1.000000,-0.085334,5.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.000000,0.914666,0.085334,5.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(3.000000,0.104607,1.104607,-0.104607);//(Unknown)
	Material.PreshaderBuffer[15] = float4(5.000000,2.000000,0.100000,-0.093333);//(Unknown)
	Material.PreshaderBuffer[16] = float4(0.906667,0.093333,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[27] = float4(0.000000,0.000000,0.250000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[30] = float4(0.000000,0.000000,0.100000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[33] = float4(0.000000,0.000000,0.200000,0.168000);//(Unknown)
	...
	Material.PreshaderBuffer[36] = float4(0.000000,0.000000,0.100000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[48] = float4(0.000000,0.100000,0.000000,0.100000);//(Unknown)
