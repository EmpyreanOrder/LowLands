...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.109375,0.109375,0.109375,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.109375,0.109375,0.109375,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local6 = (Local5 * Material.PreshaderBuffer[3].xyz);
