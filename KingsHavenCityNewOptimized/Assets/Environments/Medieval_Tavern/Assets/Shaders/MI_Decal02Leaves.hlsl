...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.173337,-2.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.762500,0.762500,0.762500,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.762500,0.762500,0.762500,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(5.979908,3.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local10 = (Material.PreshaderBuffer[4].xyz * Local8.rgb);
	...
	MaterialFloat Local13 = (Local11.g * Material.PreshaderBuffer[4].w);
	MaterialFloat Local14 = 1.0f;
	MaterialFloat Local15 = dot(((MaterialFloat3)Local8.a),MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat Local16 = PositiveClampedPow(Local15,Material.PreshaderBuffer[5].x);
	MaterialFloat Local17 = (Local14 * Local16);
	MaterialFloat Local18 = (Local17 * Material.PreshaderBuffer[5].y);
