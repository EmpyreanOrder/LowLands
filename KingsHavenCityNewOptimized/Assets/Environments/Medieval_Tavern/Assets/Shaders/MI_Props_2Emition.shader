Shader "Unreal/MI_Props_2Emition"
{
    Properties
    {
		...
		Material_Texture2D_1( "Emition", 2D ) = "white" {}
		Material_Texture2D_2( "baseColor", 2D ) = "white" {}
		Material_Texture2D_3( "ARMH", 2D ) = "white" {}
		Material_Texture2D_4( "DirtMask(UV2)", 2D ) = "white" {}
		Material_Texture2D_5( "DirtMask", 2D ) = "white" {}
		Material_Texture2D_6( "DirtMask(UV3)", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Props_2Emition.hlsl"
