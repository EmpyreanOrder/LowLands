Shader "Unreal/MI_Glass01"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Glass_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Glass_E", 2D ) = "white" {}
		Material_Texture2D_2( "T_Glass_BC", 2D ) = "white" {}
		Material_Texture2D_3( "T_Glass_ARM", 2D ) = "white" {}
