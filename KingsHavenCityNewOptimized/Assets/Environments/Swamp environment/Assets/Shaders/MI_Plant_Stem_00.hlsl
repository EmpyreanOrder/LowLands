...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.117647,0.141176,0.054902,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.400000,1.000000,0.850000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.500000,10.000000,0.000000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local15 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 0);
	MaterialFloat Local17 = (Local15.b * Material.PreshaderBuffer[3].y);
	MaterialFloat Local18 = (Material.PreshaderBuffer[3].z * Local15.g);
	MaterialFloat3 Local19 = (Local13 * ((MaterialFloat3)Material.PreshaderBuffer[3].w));
	MaterialFloat Local20 = (Local15.r * Material.PreshaderBuffer[4].y);
	...
	MaterialFloat Local24 = CustomExpression1(Parameters,Local23);
	MaterialFloat2 Local25 = (Local21 / MaterialFloat2(64.00000000,64.00000000).rg);
	MaterialFloat Local26 = MaterialStoreTexCoordScale(Parameters, Local25, 5);
	MaterialFloat4 Local27 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,Local25,View.MaterialTextureMipBias));
	MaterialFloat Local28 = MaterialStoreTexSample(Parameters, Local27, 5);
	...
	MaterialFloat Local33 = (Local32 * Material.PreshaderBuffer[4].z);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local19,Material.PreshaderBuffer[4].x);
