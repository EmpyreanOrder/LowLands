...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[10] = float4(1.638378,0.296000,0.712000,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1.638378,-0.638378,0.296000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.000000,1.000000,1.000000,0.712000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local30 = lerp(Material.PreshaderBuffer[15].w,Material.PreshaderBuffer[15].z,Local18.g.r);
	MaterialFloat3 Local31 = lerp(Material.PreshaderBuffer[16].yzw,((MaterialFloat3)Material.PreshaderBuffer[16].x),Local30);
