Shader "Unreal/MI_WildCarrot_Atlas_01"
{
    Properties
    {
		...
		Material_Texture2D_3( "Snow_ Mask", 2D ) = "white" {}
		Material_Texture2D_4( "T_Noise_01", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_WildCarrot_Atlas_01.hlsl"
