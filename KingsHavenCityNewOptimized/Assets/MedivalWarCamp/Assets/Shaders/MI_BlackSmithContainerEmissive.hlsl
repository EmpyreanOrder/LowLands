...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[9] = float4(0.880208,0.129532,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(90.453468,0.880208,0.129532,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(79.617867,11.716619,0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 1);
	MaterialFloat4 Local17 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_1,GetMaterialSharedSampler(samplerMaterial_Texture2D_1,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7)));
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 1);
	MaterialFloat3 Local19 = (Local17.rgb * Material.PreshaderBuffer[11].xyz);
	MaterialFloat3 Local20 = lerp(Local19,Material.PreshaderBuffer[12].xyz,Material.PreshaderBuffer[11].w);
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 3);
	...
	PixelMaterialInputs.Roughness = Local22.g;
