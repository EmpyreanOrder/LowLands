Shader "Unreal/EmissiveTexturedMaterial(MI_WoodBarrel_01a_Didnt_Compile_280100)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(MI_WoodBarrel_01a_Didnt_Compile_280100).hlsl"
