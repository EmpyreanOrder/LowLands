Shader "Unreal/MI_HornBeamBush_01a"
{
    Properties
    {
		...
		Material_Texture2D_1( "Base Layer Albedo Map", 2D ) = "white" {}
		Material_Texture2D_2( "Base Layer ORM Map", 2D ) = "white" {}
		Material_Texture2D_3( "Base Layer SSS Map", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_HornBeamBush_01a.hlsl"
