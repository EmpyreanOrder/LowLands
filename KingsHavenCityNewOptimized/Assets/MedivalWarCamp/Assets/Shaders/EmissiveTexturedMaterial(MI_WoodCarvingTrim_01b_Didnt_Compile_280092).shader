Shader "Unreal/EmissiveTexturedMaterial(MI_WoodCarvingTrim_01b_Didnt_Compile_280092)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        #include "EmissiveTexturedMaterial(MI_WoodCarvingTrim_01b_Didnt_Compile_280092).hlsl"
