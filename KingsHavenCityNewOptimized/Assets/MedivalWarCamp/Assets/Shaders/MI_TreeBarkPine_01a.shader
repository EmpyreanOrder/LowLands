Shader "Unreal/MI_TreeBarkPine_01a"
{
    Properties
    {
		...
		Material_Texture2D_2( "GrayscaleMask", 2D ) = "white" {}
		Material_Texture2D_3( "Base Layer ORM Map", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_TreeBarkPine_01a.hlsl"
