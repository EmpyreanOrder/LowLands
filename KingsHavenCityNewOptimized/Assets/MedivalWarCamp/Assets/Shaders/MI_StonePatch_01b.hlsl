...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[7] = float4(1.000000,9.153681,4.576840,-1.946355);//(Unknown)
	Material.PreshaderBuffer[8] = float4(-6.523195,0.300000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[13] = float4(0.616000,0.000000,1.000000,0.150000);//(Unknown)
	...
	Material.PreshaderBuffer[17] = float4(0.520000,0.176000,1.000000,0.150000);//(Unknown)
	...
	Material.PreshaderBuffer[28] = float4(0.880000,0.000000,2.000000,-1.000000);//(Unknown)
	Material.PreshaderBuffer[29] = float4(0.000000,0.320000,0.128000,1.000000);//(Unknown)
