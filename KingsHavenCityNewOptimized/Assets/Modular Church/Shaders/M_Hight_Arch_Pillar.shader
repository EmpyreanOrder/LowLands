Shader "Unreal/M_Hight_Arch_Pillar"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Hight_Arch_Pillar_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Hight_Arch_Pillar_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Hight_Arch_Pillar_RMA_UE", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Hight_Arch_Pillar.hlsl"
