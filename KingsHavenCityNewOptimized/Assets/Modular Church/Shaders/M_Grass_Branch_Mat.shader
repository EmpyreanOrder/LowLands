Shader "Unreal/M_Grass_Branch_Mat"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Grass_Normal_Tex", 2D ) = "white" {}
		Material_Texture2D_1( "T_Grass_Color", 2D ) = "white" {}
		Material_Texture2D_2( "T_Grass_alpha", 2D ) = "white" {}
		Material_Texture2D_3( "T_Grass_Subsurface_Tex", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Grass_Branch_Mat.hlsl"
