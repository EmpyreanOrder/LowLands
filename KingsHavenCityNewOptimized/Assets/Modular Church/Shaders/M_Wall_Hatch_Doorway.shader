Shader "Unreal/M_Wall_Hatch_Doorway"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Wall_Hatch_Doorway_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Wall_Hatch_Doorway_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Wall_Hatch_Doorway_RMA_UE", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Wall_Hatch_Doorway.hlsl"
