Shader "Unreal/M_Pillar_01"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Pillar_01_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Pillar_01_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Pillar_01_RMA_UE", 2D ) = "white" {}
