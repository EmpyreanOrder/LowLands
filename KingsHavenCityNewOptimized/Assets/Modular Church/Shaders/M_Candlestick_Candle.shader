Shader "Unreal/M_Candlestick_Candle"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Candlestick_Small_Candle_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Candlestick_Small_Candle_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Candlestick_Small_Candle_RMA_UE", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Candlestick_Candle.hlsl"
