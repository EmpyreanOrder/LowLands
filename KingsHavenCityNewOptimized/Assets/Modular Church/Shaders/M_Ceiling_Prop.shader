Shader "Unreal/M_Ceiling_Prop"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Ceiling_Prop_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Ceiling_Prop_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Ceiling_Prop_RMA_UE", 2D ) = "white" {}
