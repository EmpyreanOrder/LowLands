Shader "Unreal/M_Cloister_Arch"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Cloister_Arch_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Cloister_Arch_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Cloister_Arch_RMA_UE", 2D ) = "white" {}
