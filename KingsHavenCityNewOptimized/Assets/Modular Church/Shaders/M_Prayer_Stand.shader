Shader "Unreal/M_Prayer_Stand"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Prayer_Stand_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Prayer_Stand_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Prayer_Stand_RMA_UE", 2D ) = "white" {}
