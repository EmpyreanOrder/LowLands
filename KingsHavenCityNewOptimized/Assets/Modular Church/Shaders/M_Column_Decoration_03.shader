Shader "Unreal/M_Column_Decoration_03"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Column_Decoration_03_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Column_Decoration_03_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Column_Decoration_03_RMA_UE", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Column_Decoration_03.hlsl"
