...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(1.000000,0.000000,0.500000,0.500000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local51 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 2);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local52.rgb,Material.PreshaderBuffer[4].y);
	PixelMaterialInputs.AmbientOcclusion = Material.PreshaderBuffer[4].w;
