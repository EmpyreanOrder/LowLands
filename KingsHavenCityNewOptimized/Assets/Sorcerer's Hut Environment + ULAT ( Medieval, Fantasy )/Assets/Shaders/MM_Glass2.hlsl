...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = PositiveClampedPow(Local5,Material.PreshaderBuffer[2].x);
	MaterialFloat Local7 = (Local6 * (1.00000000 - 0.04000000));
	MaterialFloat Local8 = (Local7 + 0.04000000);
	MaterialFloat Local9 = lerp(1.00000000,1.23000002,Local8);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 0.50000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = MaterialFloat3(0.19270800,0.19270800,0.19270800);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local9,0.0f),Material.PreshaderBuffer[2].y);
