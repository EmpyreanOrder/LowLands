...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.539107,0.880208,0.045844,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.539107,0.880208,0.045844,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.600000,0.600000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local51 = (Local6.rgb * Material.PreshaderBuffer[6].xyz);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local51,Material.PreshaderBuffer[6].w);
	PixelMaterialInputs.AmbientOcclusion = Material.PreshaderBuffer[7].y;
