...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.369792,0.302036,0.219564,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.369792,0.302036,0.219564,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.800000,0.800000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local48 = (Local6.rgb * Material.PreshaderBuffer[6].xyz);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local48,Material.PreshaderBuffer[6].w);
