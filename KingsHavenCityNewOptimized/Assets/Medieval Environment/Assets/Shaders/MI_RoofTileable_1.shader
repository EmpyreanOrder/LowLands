Shader "Unreal/MI_RoofTileable_1"
{
    Properties
    {
		...
		Material_Texture2D_0( "VP_N_AO_R", 2D ) = "white" {}
		Material_Texture2D_1( "N_AO_R", 2D ) = "white" {}
		Material_Texture2D_2( "T_MaskTexture_RGB", 2D ) = "white" {}
		Material_Texture2D_3( "VP_BC", 2D ) = "white" {}
		Material_Texture2D_4( "BC_O", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_RoofTileable_1.hlsl"
