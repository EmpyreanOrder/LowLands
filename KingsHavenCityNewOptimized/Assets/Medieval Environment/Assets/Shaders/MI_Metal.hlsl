...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.020833,0.020833,0.020833,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.020833,0.020833,0.020833,1.017134);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,1.590694,1.251649,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = (Local4.g * Material.PreshaderBuffer[4].z);
