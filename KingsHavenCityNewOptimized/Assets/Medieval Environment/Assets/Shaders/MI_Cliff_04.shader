Shader "Unreal/MI_Cliff_04"
{
    Properties
    {
		...
		Material_Texture2D_0( "N_S_D", 2D ) = "white" {}
		Material_Texture2D_1( "Detail Texture", 2D ) = "white" {}
		Material_Texture2D_2( "T_Crack_NSD", 2D ) = "white" {}
		Material_Texture2D_3( "Ground_1 Diffuse", 2D ) = "white" {}
		Material_Texture2D_4( "BC_R", 2D ) = "white" {}
		Material_Texture2D_5( "T_Leakage_BC", 2D ) = "white" {}
		Material_Texture2D_6( "T_GrassVariation", 2D ) = "white" {}
