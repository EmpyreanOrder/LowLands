Shader "Unreal/MI_door_01_blue(MaterialInstanceDynamic_0_152499)"
{
    Properties
    {
		...
		Material_Texture2D_1( "Base N_detail", 2D ) = "white" {}
		Material_Texture2D_2( "Em", 2D ) = "white" {}
		Material_Texture2D_3( "BC", 2D ) = "white" {}
		Material_Texture2D_4( "MRA", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_door_01_blue(MaterialInstanceDynamic_0_152499).hlsl"
