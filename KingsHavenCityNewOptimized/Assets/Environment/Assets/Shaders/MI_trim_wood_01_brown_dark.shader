Shader "Unreal/MI_trim_wood_01_brown_dark"
{
    Properties
    {
		...
		Material_Texture2D_0( "N_1", 2D ) = "white" {}
		Material_Texture2D_1( "N_2", 2D ) = "white" {}
		Material_Texture2D_2( "Mask", 2D ) = "white" {}
		Material_Texture2D_3( "T_mask_trim_wood_01_01", 2D ) = "white" {}
		Material_Texture2D_4( "ND", 2D ) = "white" {}
		Material_Texture2D_5( "BC_1", 2D ) = "white" {}
		Material_Texture2D_6( "BC_2", 2D ) = "white" {}
		Material_Texture2D_7( "MRA_1", 2D ) = "white" {}
		Material_Texture2D_8( "MRA_2", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_trim_wood_01_brown_dark.hlsl"
