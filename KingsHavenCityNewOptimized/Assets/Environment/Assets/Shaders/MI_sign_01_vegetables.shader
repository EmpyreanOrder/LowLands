Shader "Unreal/MI_sign_01_vegetables"
{
    Properties
    {
		...
		Material_Texture2D_0( "Outline texture", 2D ) = "white" {}
		Material_Texture2D_1( "Opacity texture", 2D ) = "white" {}
		Material_Texture2D_2( "Grunge Texture", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_sign_01_vegetables.hlsl"
