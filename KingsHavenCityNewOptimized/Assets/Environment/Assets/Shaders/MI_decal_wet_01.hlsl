...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,1.200000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.391493,0.439553,0.458333,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.391493,0.439553,0.458333,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,1.000000,0.000000,1.200000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local18 = (Local9.a * Material.PreshaderBuffer[6].w);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[7].x);
