...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.492691,1.000000,0.290000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.492691,1.000000,0.290000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.507309,0.000000,0.710000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.014618,0.000000,1.420000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.985382,2.000000,0.580000,0.492691);//(Unknown)
	Material.PreshaderBuffer[8] = float4(1.000000,0.290000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.408963,1.000000,0.318000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.408963,1.000000,0.318000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.591037,0.000000,0.682000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(0.847000,0.490000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.000000,0.847000,0.490000,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.847000,0.490000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[17] = float4(0.000000,1.800000,1.000000,1.500000);//(Unknown)
	Material.PreshaderBuffer[18] = float4(10000.000000,0.000100,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[19] = float4(0.710000,0.800000,1.100000,0.000000);//(Unknown)
	Material.PreshaderBuffer[20] = float4(0.800000,0.710000,0.290000,1.100000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(1.000000,0.281447,0.000000,0.810000);//(Unknown)
	Material.PreshaderBuffer[22] = float4(1.000000,0.281447,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[23] = float4(0.000000,0.718553,1.000000,0.810000);//(Unknown)
	...
	Material.PreshaderBuffer[26] = float4(0.000000,0.000000,0.000000,0.200000);//(Unknown)
...
MaterialFloat3 CustomExpression1(FMaterialVertexParameters Parameters,MaterialFloat InValue)
{
#if COMPILER_HLSL
...
{
	MaterialFloat3 Local97 = CustomExpression1(Parameters,0.00000000);
	return Local97;;
}
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local98 = (Local53.b * Material.PreshaderBuffer[20].x);
	MaterialFloat3 Local99 = (Local62 * ((MaterialFloat3)Local98));
	MaterialFloat Local100 = dot(Local99,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local101 = lerp(Local99,((MaterialFloat3)Local100),Material.PreshaderBuffer[20].z);
	MaterialFloat3 Local102 = PositiveClampedPow(Local101,((MaterialFloat3)Material.PreshaderBuffer[20].w));
	MaterialFloat3 Local103 = (((MaterialFloat3)1.00000000) - Local102);
	MaterialFloat3 Local104 = (Local103 * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local105 = (Local104 * Material.PreshaderBuffer[23].xyz);
	MaterialFloat3 Local106 = (((MaterialFloat3)1.00000000) - Local105);
	MaterialFloat3 Local107 = (Local102 * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local108 = (Local107 * Material.PreshaderBuffer[22].xyz);
	...
	MaterialFloat3 Local112 = lerp(Local102,MaterialFloat3(MaterialFloat2(Local109,Local110),Local111),Material.PreshaderBuffer[23].w);
	MaterialFloat3 Local113 = (((MaterialFloat3)1.00000000) - Local112);
	MaterialFloat3 Local114 = (Local113 * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local115 = (Local114 * Material.PreshaderBuffer[26].xyz);
	MaterialFloat3 Local116 = (((MaterialFloat3)1.00000000) - Local115);
	MaterialFloat3 Local117 = (Local112 * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local118 = (Local117 * Material.PreshaderBuffer[25].xyz);
	MaterialFloat Local119 = select((Local112.r >= 0.50000000), Local116.r, Local118.r);
	MaterialFloat Local120 = select((Local112.g >= 0.50000000), Local116.g, Local118.g);
	MaterialFloat Local121 = select((Local112.b >= 0.50000000), Local116.b, Local118.b);
	MaterialFloat4 Local122 = Parameters.VertexColor;
	MaterialFloat Local123 = DERIV_BASE_VALUE(Local122).a;
	MaterialFloat3 Local124 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),((MaterialFloat3)DERIV_BASE_VALUE(Local123)),Local57);
	MaterialFloat3 Local125 = lerp(Local112,MaterialFloat3(MaterialFloat2(Local119,Local120),Local121),Local124);
	MaterialFloat3 Local126 = lerp(Local112,Local125,Material.PreshaderBuffer[26].w);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local126,Material.PreshaderBuffer[27].x);
