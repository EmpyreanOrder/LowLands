Shader "Unreal/MI_Sky(MI_Sky_Animated_0_67559)"
{
    Properties
    {
		...
		Material_TextureCube_1( "TC_kloppenheim_06_puresky_4k_photoshop_gr", Cube ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Sky(MI_Sky_Animated_0_67559).hlsl"
