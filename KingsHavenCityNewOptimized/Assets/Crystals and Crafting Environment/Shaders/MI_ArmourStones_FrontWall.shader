Shader "Unreal/MI_ArmourStones_FrontWall"
{
    Properties
    {
		...
		Material_Texture2D_1( "RGBA Masks", 2D ) = "white" {}
		Material_Texture2D_2( "Detail Nrm Map", 2D ) = "white" {}
		Material_Texture2D_3( "Emissive Map", 2D ) = "white" {}
		Material_Texture2D_4( "Albedo Map", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_ArmourStones_FrontWall.hlsl"
