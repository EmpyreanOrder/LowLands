...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[14] = float4(0.000000,0.340000,1.710000,1.220000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(1.000000,0.810000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(0.000000,0.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[17] = float4(0.000000,0.000000,0.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[20] = float4(3.200000,0.560784,0.160784,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[25] = float4(-0.050000,1.794509,0.514509,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[44] = float4(0.380000,0.311684,0.266000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[47] = float4(0.380000,0.311684,0.266000,0.000000);//(Unknown)
