...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.000000,1.550000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[6] = float4(0.000000,1.900000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(0.000000,2.000000,1.000000,0.560000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1.000000,0.260000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.500000,0.800000,2.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(2.000000,2.000000,0.100000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1.800000,-0.800000,1.500000,-0.500000);//(Unknown)
	...
	Material.PreshaderBuffer[25] = float4(1.000000,1.000000,1.000000,0.800000);//(Unknown)
	Material.PreshaderBuffer[26] = float4(0.800000,0.200000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[27] = float4(0.802083,0.581929,0.413574,1.000000);//(Unknown)
	Material.PreshaderBuffer[28] = float4(0.820000,0.802083,0.581929,0.413574);//(Unknown)
	...
	Material.PreshaderBuffer[31] = float4(0.710000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[32] = float4(1.000000,0.854152,0.698812,1.000000);//(Unknown)
	Material.PreshaderBuffer[33] = float4(1.000000,0.854152,0.698812,1.000000);//(Unknown)
	Material.PreshaderBuffer[34] = float4(1.000000,0.000000,0.500000,0.500000);//(Unknown)
	Material.PreshaderBuffer[35] = float4(0.500000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[36] = float4(0.000000,1.000000,0.580000,1.100000);//(Unknown)
	Material.PreshaderBuffer[37] = float4(-0.450000,0.920000,0.000000,0.000000);//(Unknown)
