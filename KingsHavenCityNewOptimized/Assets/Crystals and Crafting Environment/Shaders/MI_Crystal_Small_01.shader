Shader "Unreal/MI_Crystal_Small_01"
{
    Properties
    {
		...
		Material_Texture2D_0( "Nrm Map (B)", 2D ) = "white" {}
		Material_Texture2D_1( "Nrm Map (R)", 2D ) = "white" {}
		Material_Texture2D_2( "Nrm Map", 2D ) = "white" {}
		Material_Texture2D_3( "Detail Nrm Map", 2D ) = "white" {}
		Material_Texture2D_4( "VP_H Map", 2D ) = "white" {}
		Material_Texture2D_5( "Contrast Texture", 2D ) = "white" {}
		Material_Texture2D_6( "Crystal Nrm", 2D ) = "white" {}
		Material_Texture2D_7( "T_Crystal_Pits_Nrm", 2D ) = "white" {}
		Material_Texture2D_8( "T_Crystal_Knapping_Nrm", 2D ) = "white" {}
		Material_Texture2D_9( "T_Crystal_Directional_Nrm", 2D ) = "white" {}
		Material_Texture2D_10( "Unique Crystal Masks", 2D ) = "white" {}
		Material_Texture2D_11( "Crystal Shader Mask", 2D ) = "white" {}
		Material_Texture2D_12( "Emissive Map", 2D ) = "white" {}
		Material_Texture2D_13( "Albedo Map (B)", 2D ) = "white" {}
		Material_Texture2D_14( "Albedo Map (R)", 2D ) = "white" {}
		Material_Texture2D_15( "Albedo Map", 2D ) = "white" {}
		Material_Texture2D_16( "T_Crystal_Detail_Masks", 2D ) = "white" {}
		Material_Texture2D_17( "AORM Map (B)", 2D ) = "white" {}
		Material_Texture2D_18( "AORM Map (R)", 2D ) = "white" {}
		Material_Texture2D_19( "AORM Map", 2D ) = "white" {}
		Material_TextureCube_0( "studio_small_01_8k", Cube ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Crystal_Small_01.hlsl"
