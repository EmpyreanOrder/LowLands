Shader "Unreal/MI_PropKit01_Plates"
{
    Properties
    {
		...
		Material_Texture2D_0( "Nrm Map", 2D ) = "white" {}
		Material_Texture2D_1( "Detail Nrm Map", 2D ) = "white" {}
		Material_Texture2D_2( "Emissive Map", 2D ) = "white" {}
		Material_Texture2D_3( "Albedo Map", 2D ) = "white" {}
		Material_Texture2D_4( "Colour Position Random Mask", 2D ) = "white" {}
		Material_Texture2D_5( "AORM Map", 2D ) = "white" {}
		Material_Texture2D_6( "OM Map", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_PropKit01_Plates.hlsl"
