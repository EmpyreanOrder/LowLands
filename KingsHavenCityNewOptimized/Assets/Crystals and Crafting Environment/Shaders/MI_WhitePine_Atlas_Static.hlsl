...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[9] = float4(10000.000000,0.000100,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.000000,1.000000,1.200000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1.000000,0.000000,1.000000,1.200000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(-0.848000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(-0.848000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(1.848000,0.000000,0.000000,0.200000);//(Unknown)
...
{
	MaterialFloat3 Local53 = CustomExpression1(Parameters,0.00000000);
	return Local53;;
}
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local54 = (Local14.b * Material.PreshaderBuffer[11].x);
	MaterialFloat3 Local55 = (Local12 * ((MaterialFloat3)Local54));
	MaterialFloat Local56 = dot(Local55,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local57 = lerp(Local55,((MaterialFloat3)Local56),Material.PreshaderBuffer[11].z);
	MaterialFloat3 Local58 = PositiveClampedPow(Local57,((MaterialFloat3)Material.PreshaderBuffer[11].w));
	MaterialFloat3 Local59 = (((MaterialFloat3)1.00000000) - Local58);
	MaterialFloat3 Local60 = (Local59 * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local61 = (Local60 * Material.PreshaderBuffer[14].xyz);
	MaterialFloat3 Local62 = (((MaterialFloat3)1.00000000) - Local61);
	MaterialFloat3 Local63 = (Local58 * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local64 = (Local63 * Material.PreshaderBuffer[13].xyz);
	MaterialFloat Local65 = select((Local58.r >= 0.50000000), Local62.r, Local64.r);
	MaterialFloat Local66 = select((Local58.g >= 0.50000000), Local62.g, Local64.g);
	MaterialFloat Local67 = select((Local58.b >= 0.50000000), Local62.b, Local64.b);
	MaterialFloat4 Local68 = Parameters.VertexColor;
	MaterialFloat Local69 = DERIV_BASE_VALUE(Local68).a;
	MaterialFloat3 Local70 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),((MaterialFloat3)DERIV_BASE_VALUE(Local69)),Local24);
	MaterialFloat3 Local71 = lerp(Local58,MaterialFloat3(MaterialFloat2(Local65,Local66),Local67),Local70);
	MaterialFloat3 Local72 = lerp(Local58,Local71,Material.PreshaderBuffer[14].w);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local72,Material.PreshaderBuffer[15].x);
