Shader "Unreal/MI_PlasterWall_FrontWall"
{
    Properties
    {
		...
		Material_Texture2D_3( "RGBA Masks", 2D ) = "white" {}
		Material_Texture2D_4( "Detail Nrm Map", 2D ) = "white" {}
		Material_Texture2D_5( "VP_H Map", 2D ) = "white" {}
		Material_Texture2D_6( "Contrast Texture", 2D ) = "white" {}
		Material_Texture2D_7( "Albedo Map (B)", 2D ) = "white" {}
		Material_Texture2D_8( "Albedo Map (R)", 2D ) = "white" {}
		Material_Texture2D_9( "Albedo Map", 2D ) = "white" {}
		Material_Texture2D_10( "AORM Map (B)", 2D ) = "white" {}
		Material_Texture2D_11( "AORM Map (R)", 2D ) = "white" {}
		Material_Texture2D_12( "AORM Map", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_PlasterWall_FrontWall.hlsl"
