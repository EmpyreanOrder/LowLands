...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[10] = float4(0.580000,0.400000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1.000000,1.000000,0.100000,1.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.400000,-0.400000,1.580000,-0.580000);//(Unknown)
	...
	Material.PreshaderBuffer[25] = float4(1.350000,-0.350000,0.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[28] = float4(0.800000,0.000000,0.000000,0.000000);//(Unknown)
