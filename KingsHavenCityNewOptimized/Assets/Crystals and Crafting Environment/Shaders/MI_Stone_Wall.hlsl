...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,1.800000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.700000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(1.000000,1.000000,1.056956,1.257378);//(Unknown)
	Material.PreshaderBuffer[8] = float4(1.000000,1.000000,2.000000,1.056956);//(Unknown)
	Material.PreshaderBuffer[9] = float4(1.257378,1.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[25] = float4(1.000000,0.000000,1.000000,1.000000);//(Unknown)
