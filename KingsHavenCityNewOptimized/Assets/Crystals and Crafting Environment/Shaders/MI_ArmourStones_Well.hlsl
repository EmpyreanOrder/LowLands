...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[9] = float4(0.000000,2.100000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[24] = float4(1.000000,1.000000,1.000000,0.721000);//(Unknown)
