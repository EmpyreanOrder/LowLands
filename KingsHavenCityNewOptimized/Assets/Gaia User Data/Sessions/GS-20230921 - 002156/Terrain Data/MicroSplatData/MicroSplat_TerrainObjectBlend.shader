...
Shader "Terrain_2_3-20230921 - 002825_TerrainObjectBlend"
{
   Properties
   {
   ...
   SubShader
   {
            Tags {"RenderPipeline" = "UniversalPipeline"  "RenderType" = "UniversalLitShader" "Queue" = "Transparent+100" "IgnoreProjector" = "False"  "TerrainCompatible" = "true" "SplatCount" = "12"}
