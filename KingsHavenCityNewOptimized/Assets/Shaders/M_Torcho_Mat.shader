Shader "Unreal/M_Torcho_Mat"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Torcho_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Torcho_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_Torcho_ORM", 2D ) = "white" {}
