...
Shader  "Amplify Unscripted Decal Shader"
{
	Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			)
			{
				...
				float4 tex2DNode9 = tex2D( _Color, uv_Color );
				float4 blendOpSrc15 = tex2DNode9;
				float4 blendOpDest15 = ( _LocalTint * saturate( ( _LocalContrast + tex2DNode9.r ) ) );
				
				float2 uv_NormalMap = texCoord0 * _NormalMap_ST.xy + _NormalMap_ST.zw;
				

				surfaceDescription.BaseColor = ( saturate( 2.0f*blendOpDest15*blendOpSrc15 + blendOpDest15*blendOpDest15*(1.0f - 2.0f*blendOpSrc15) )).rgb;
        ...
        Pass
        {
			...
			)
			{
				...
				float3 BaseColor = ( saturate( 2.0f*blendOpDest15*blendOpSrc15 + blendOpDest15*blendOpDest15*(1.0f - 2.0f*blendOpSrc15) )).rgb;
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.SamplerNode;9;-1053.169,-110.6224;Inherit;True;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;-1;None;464ee7c4d3466b446bfc0d037e48246c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;10;-1005.485,-282.5823;Inherit;False;Property;_LocalContrast;Local Contrast;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;11;-731.8854,-210.582;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;12;-611.8856,-204.1817;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;13;-811.3688,-429.3798;Inherit;False;Property;_LocalTint;Local Tint;2;0;Create;True;0;0;0;False;0;False;0.4811321,0.4811321,0.4811321,0;0.4811321,0.4811321,0.4811321,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-464.6859,-253.7829;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;15;-284.0014,-114.3777;Inherit;False;SoftLight;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;16;-774.2259,153.6675;Inherit;True;Property;_NormalMap;Normal Map;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=225EDC272F8B0785A2F4777AC67AEED832D76ADF