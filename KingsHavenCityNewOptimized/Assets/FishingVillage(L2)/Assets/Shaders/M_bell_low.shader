Shader "Unreal/M_bell_low"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_bell_bell_low_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_bell_bell_low_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_bell_bell_low_OcclusionRoughnessMetallic", 2D ) = "white" {}
