Shader "Unreal/M_door_2_lock_low1"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_door_2_lock_low_door_2_lock_low_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_door_2_lock_low_door_2_lock_low_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_door_2_lock_low_door_2_lock_low_OcclusionRoughnessMetallic", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_door_2_lock_low1.hlsl"
