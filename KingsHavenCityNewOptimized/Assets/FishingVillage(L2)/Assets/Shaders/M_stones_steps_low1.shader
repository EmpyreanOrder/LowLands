Shader "Unreal/M_stones_steps_low1"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_stones_steps_low_stones_steps_low_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_stones_steps_low_stones_steps_low_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_stones_steps_low_stones_steps_low_OcclusionRoughnessMetallic", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_stones_steps_low1.hlsl"
