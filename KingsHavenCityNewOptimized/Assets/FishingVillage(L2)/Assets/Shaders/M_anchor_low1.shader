Shader "Unreal/M_anchor_low1"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_anchor_low_anchor_low_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_anchor_low_anchor_low_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_anchor_low_anchor_low_OcclusionRoughnessMetallic", 2D ) = "white" {}
