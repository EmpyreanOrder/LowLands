Shader "Unreal/MI_RoofTilesBumps"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_RoofTiles_H", 2D ) = "white" {}
		Material_Texture2D_1( "T_RoofTiles_N", 2D ) = "white" {}
		Material_Texture2D_2( "T_RoofTiles_B", 2D ) = "white" {}
		Material_Texture2D_3( "T_Moss_B", 2D ) = "white" {}
		Material_Texture2D_4( "T_RoofTiles_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_RoofTilesBumps.hlsl"
