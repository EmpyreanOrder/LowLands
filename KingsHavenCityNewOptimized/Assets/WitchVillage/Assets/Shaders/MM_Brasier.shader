Shader "Unreal/MM_Brasier"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Brasier_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Brasier_E", 2D ) = "white" {}
		Material_Texture2D_2( "T_Brasier_B", 2D ) = "white" {}
		Material_Texture2D_3( "T_Brasier_ORM", 2D ) = "white" {}
