Shader "Unreal/MM_TwistedBranches"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_TwistedBranch_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_TwistedBranch_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_SwampMud_B", 2D ) = "white" {}
		Material_Texture2D_3( "T_TwistedBranch_ORM", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MM_TwistedBranches.hlsl"
