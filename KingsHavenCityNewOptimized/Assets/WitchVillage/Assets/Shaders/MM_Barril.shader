Shader "Unreal/MM_Barril"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Barril_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Barril_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Barril_ORM", 2D ) = "white" {}
