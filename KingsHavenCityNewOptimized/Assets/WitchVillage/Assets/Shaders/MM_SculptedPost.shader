Shader "Unreal/MM_SculptedPost"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SculptedPost_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SculptedPost_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_SculptedPost_ORM", 2D ) = "white" {}
