...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.138432,0.045933,0.018122,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.138432,0.045933,0.018122,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local11 = (Local6.a * Material.PreshaderBuffer[2].x);
	MaterialFloat Local12 = (1.00000000 - Local11);
	MaterialFloat3 Local13 = (((MaterialFloat3)Local6.a) * Material.PreshaderBuffer[4].xyz);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local13,Material.PreshaderBuffer[4].w);
