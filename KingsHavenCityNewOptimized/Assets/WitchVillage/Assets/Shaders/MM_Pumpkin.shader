Shader "Unreal/MM_Pumpkin"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Pumpkin_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Pumpkin_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Pumpkin_R", 2D ) = "white" {}
