Shader "Unreal/MM_BlackMangrove"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MangroveBark_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MangroveBark_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_MangroveBark_ORM", 2D ) = "white" {}
