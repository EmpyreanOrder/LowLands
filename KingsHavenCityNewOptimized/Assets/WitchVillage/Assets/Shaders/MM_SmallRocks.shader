Shader "Unreal/MM_SmallRocks"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SmallRocks_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SmallRocks_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Moss_B", 2D ) = "white" {}
		Material_Texture2D_3( "T_SwampMud_B", 2D ) = "white" {}
		Material_Texture2D_4( "T_SmallRocks_ORM", 2D ) = "white" {}
		Material_Texture2D_5( "T_Moss_R", 2D ) = "white" {}
