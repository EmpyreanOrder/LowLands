Shader "Unreal/MI_LilipadDecal"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_GaussianNoise", 2D ) = "white" {}
		Material_Texture2D_1( "T_Lilypads_N", 2D ) = "white" {}
		Material_Texture2D_2( "T_Lilypads_B", 2D ) = "white" {}
		Material_Texture2D_3( "T_Lilypads_ORM", 2D ) = "white" {}
