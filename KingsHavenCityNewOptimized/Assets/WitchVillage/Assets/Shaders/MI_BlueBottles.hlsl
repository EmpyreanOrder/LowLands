...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.259443,1.630129,1.757054,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local8 = (Local6.rgb * ((MaterialFloat3)Material.PreshaderBuffer[2].z));
	MaterialFloat3 Local9 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000)),Material.PreshaderBuffer[2].y),((MaterialFloat3)0.00000000),Local8);
	MaterialFloat3 Local10 = (Local9 + Local8);
	...
	MaterialFloat3 Local14 = lerp(Local6.rgb,Local10,Local12.b);
