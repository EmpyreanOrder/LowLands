Shader "Unreal/MM_WhiteMoss"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_WhiteMoss_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_WhiteMoss_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_WhiteMoss_ORM", 2D ) = "white" {}
