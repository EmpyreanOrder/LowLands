Shader "Unreal/MM_Bench"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Bench_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Bench_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Bench_R", 2D ) = "white" {}
