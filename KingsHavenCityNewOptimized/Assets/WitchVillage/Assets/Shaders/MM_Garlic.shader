Shader "Unreal/MM_Garlic"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Garlic_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Garlic_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Garlic_ORM", 2D ) = "white" {}
