Shader "Unreal/MI_BlueBottles"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Bottle_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Bottle_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Bottle_ORMask", 2D ) = "white" {}
