...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.000000,0.446930,0.553070,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local11 = (((MaterialFloat3)0.00000000) * Local9.rgb);
	MaterialFloat3 Local12 = lerp(Local9.rgb,Local11,Material.PreshaderBuffer[2].x);
	MaterialFloat4 Local13 = Parameters.VertexColor;
	MaterialFloat Local14 = DERIV_BASE_VALUE(Local13).r;
	MaterialFloat3 Local15 = lerp(Local6.rgb,Local12,DERIV_BASE_VALUE(Local14));
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local17 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	...
	MaterialFloat4 Local20 = Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local21 = MaterialStoreTexSample(Parameters, Local20, 4);
	MaterialFloat Local22 = lerp(Local20.g,1.00000000,Material.PreshaderBuffer[2].z);
	MaterialFloat Local23 = lerp(Local17.g,Local22,DERIV_BASE_VALUE(Local14));
