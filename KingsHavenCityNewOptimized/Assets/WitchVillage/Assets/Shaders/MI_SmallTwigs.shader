Shader "Unreal/MI_SmallTwigs"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Twigs_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Twigs_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Twigs_ORM", 2D ) = "white" {}
