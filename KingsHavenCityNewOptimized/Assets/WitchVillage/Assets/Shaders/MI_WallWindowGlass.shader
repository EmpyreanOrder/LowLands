Shader "Unreal/MI_WallWindowGlass"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_WindowGlass_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_WindowGlass_Mask", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_WallWindowGlass.hlsl"
