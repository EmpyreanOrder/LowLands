...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local11 = lerp(Local9.g,1.00000000,Material.PreshaderBuffer[2].y);
	MaterialFloat Local12 = (Local6.a * Material.PreshaderBuffer[2].z);
