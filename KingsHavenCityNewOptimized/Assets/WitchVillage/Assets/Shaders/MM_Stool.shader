Shader "Unreal/MM_Stool"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Stool_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Stool_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Stool_R", 2D ) = "white" {}
