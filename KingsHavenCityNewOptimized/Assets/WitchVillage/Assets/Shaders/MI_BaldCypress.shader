Shader "Unreal/MI_BaldCypress"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_Moss_N", 2D ) = "white" {}
		Material_Texture2D_2( "Moss_Bark2_Normal_Crevices", 2D ) = "white" {}
		Material_Texture2D_3( "BakedNormals", 2D ) = "white" {}
		Material_Texture2D_4( "Bark1_Albedo", 2D ) = "white" {}
		Material_Texture2D_5( "T_Moss_B", 2D ) = "white" {}
		Material_Texture2D_6( "Bark1_AO_R_M", 2D ) = "white" {}
