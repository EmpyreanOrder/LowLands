Shader "Unreal/MM_DeadBranches"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SmallBranches_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_SmallBranches_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_SmallBranches_ORM", 2D ) = "white" {}
