Shader "Unreal/MM_Fireplace"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Fireplace_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Fireplace_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Fireplace_ORM", 2D ) = "white" {}
