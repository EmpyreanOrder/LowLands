Shader "Unreal/MM_Chains"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Chain_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Chain_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Chain_ORM", 2D ) = "white" {}
