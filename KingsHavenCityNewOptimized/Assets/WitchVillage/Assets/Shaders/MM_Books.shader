Shader "Unreal/MM_Books"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Books_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Books_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Books_Mask", 2D ) = "white" {}
		Material_Texture2D_3( "T_Books_R", 2D ) = "white" {}
