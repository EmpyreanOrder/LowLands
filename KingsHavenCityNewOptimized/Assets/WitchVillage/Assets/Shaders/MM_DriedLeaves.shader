Shader "Unreal/MM_DriedLeaves"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_IndividualLeaves_DriedLeaves_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_IndividualLeaves_DriedLeaves_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_IndividualLeaves_DriedLeaves_ORM", 2D ) = "white" {}
