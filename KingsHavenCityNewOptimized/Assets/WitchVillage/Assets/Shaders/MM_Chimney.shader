Shader "Unreal/MM_Chimney"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Chimney_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_StoneSlate_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Chimney_Mask", 2D ) = "white" {}
		Material_Texture2D_3( "T_Moss_B", 2D ) = "white" {}
		Material_Texture2D_4( "T_StoneSlate_ORM", 2D ) = "white" {}
