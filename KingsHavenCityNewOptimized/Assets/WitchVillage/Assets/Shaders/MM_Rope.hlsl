...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.000000,0.664346,0.100000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local9 = lerp(Local6.rgb,((MaterialFloat3)Local8),Material.PreshaderBuffer[2].x);
	MaterialFloat3 Local10 = (((MaterialFloat3)0.00000000) * Local9);
	MaterialFloat3 Local11 = lerp(Local9,Local10,Material.PreshaderBuffer[2].y);
