Shader "Unreal/MI_BayouWater_NoPlugin"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_Duckweed_N", 2D ) = "white" {}
		Material_Texture2D_2( "T_Duckweed_B", 2D ) = "white" {}
		Material_Texture2D_3( "T_SwampWeed_noise_Mask", 2D ) = "white" {}
		Material_Texture2D_4( "T_SwampWeed_N", 2D ) = "white" {}
		Material_Texture2D_5( "T_SwampySurface_B", 2D ) = "white" {}
		Material_Texture2D_6( "T_SwampWeed_Mask", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_BayouWater_NoPlugin.hlsl"
