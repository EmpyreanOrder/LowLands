Shader "Unreal/MI_WhiteRopes"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Rope_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Rope_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Ropes_ORM", 2D ) = "white" {}
