Shader "Unreal/MM_MossClump_Layered"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_MossClump_MultipleAtlas_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MossClump_MultipleAtlas_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_MossClump_MultipleAtlas_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MM_MossClump_Layered.hlsl"
