Shader "Unreal/MM_TwigWalls"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Tree1_B", 2D ) = "white" {}
		Material_Texture2D_1( "T_Moss_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_TwigWall_Mask", 2D ) = "white" {}
		Material_Texture2D_3( "T_Tree1_ORM", 2D ) = "white" {}
		Material_Texture2D_4( "T_Moss_R", 2D ) = "white" {}
