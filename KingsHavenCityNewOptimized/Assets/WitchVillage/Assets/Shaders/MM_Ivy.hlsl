...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.544000,0.456000,0.090000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local11 = lerp(Local9.rgb,((MaterialFloat3)1.00000000),Material.PreshaderBuffer[2].y);
	...
	MaterialFloat3 Local18 = (Local16.rgb * ((MaterialFloat3)Material.PreshaderBuffer[2].z));

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local13.r;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local18,Material.PreshaderBuffer[2].w);
