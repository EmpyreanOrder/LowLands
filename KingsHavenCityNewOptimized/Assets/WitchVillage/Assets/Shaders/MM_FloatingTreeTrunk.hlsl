...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.213904,0.223958,0.212313,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.213904,0.223958,0.212313,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.192349,0.239583,0.047418,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.192349,0.239583,0.047418,0.444000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local11 = lerp(Local6.rgb,Local8,DERIV_BASE_VALUE(Local10));
	MaterialFloat3 Local12 = (Material.PreshaderBuffer[5].xyz * Local6.rgb);
	MaterialFloat Local13 = DERIV_BASE_VALUE(Local9).g;
	MaterialFloat3 Local14 = lerp(Local11,Local12,DERIV_BASE_VALUE(Local13));
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local16 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 1);
	MaterialFloat Local18 = lerp(Local16.g,Material.PreshaderBuffer[5].w,DERIV_BASE_VALUE(Local10));
