Shader "Unreal/MM_Bucket"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Bucket_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Bucket_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Bucket_ORM", 2D ) = "white" {}
