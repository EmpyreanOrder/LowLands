Shader "Unreal/MM_Rags"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Rags_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Rags_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Rags_R", 2D ) = "white" {}
