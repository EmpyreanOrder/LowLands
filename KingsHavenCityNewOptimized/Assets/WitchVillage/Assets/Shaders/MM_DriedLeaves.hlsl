...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.700000,0.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local10 = (DERIV_BASE_VALUE(Local9) * Local6.rgb);
	MaterialFloat3 Local11 = lerp(Local6.rgb,Local10,Material.PreshaderBuffer[2].x);
