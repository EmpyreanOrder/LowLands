Shader "Unreal/MM_Drapes"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Drape_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Drape_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Drape_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_Drape_O", 2D ) = "white" {}
