Shader "Unreal/MM_PineBark"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Tree2_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Tree2_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Tree2_ORM", 2D ) = "white" {}
