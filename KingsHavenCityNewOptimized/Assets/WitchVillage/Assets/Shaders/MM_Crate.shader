Shader "Unreal/MM_Crate"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Crate_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Crate_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Crate_R", 2D ) = "white" {}
