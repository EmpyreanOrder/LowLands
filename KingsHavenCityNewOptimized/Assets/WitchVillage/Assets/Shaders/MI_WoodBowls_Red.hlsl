...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.130208,0.001243,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.130208,0.001243,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local11 = (((MaterialFloat3)Local9.a) * Material.PreshaderBuffer[3].xyz);
	MaterialFloat4 Local12 = Parameters.VertexColor;
	MaterialFloat3 Local13 = DERIV_BASE_VALUE(Local12).rgb;
	MaterialFloat3 Local14 = (DERIV_BASE_VALUE(Local13) * ((MaterialFloat3)Local6.a));
	MaterialFloat3 Local15 = lerp(Local6.rgb,Local11,Local14);
