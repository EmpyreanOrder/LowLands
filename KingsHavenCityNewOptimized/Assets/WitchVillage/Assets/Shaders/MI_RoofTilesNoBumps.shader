Shader "Unreal/MI_RoofTilesNoBumps"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_RoofTiles_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_RoofTiles_B", 2D ) = "white" {}
		Material_Texture2D_2( "T_Moss_B", 2D ) = "white" {}
		Material_Texture2D_3( "T_RoofTiles_AO", 2D ) = "white" {}
		Material_Texture2D_4( "T_RoofTiles_H", 2D ) = "white" {}
		Material_Texture2D_5( "T_RoofTiles_ORMH", 2D ) = "white" {}
		Material_Texture2D_6( "T_PLank_trimSheet_Mask", 2D ) = "white" {}
		Material_Texture2D_7( "T_Moss_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_RoofTilesNoBumps.hlsl"
