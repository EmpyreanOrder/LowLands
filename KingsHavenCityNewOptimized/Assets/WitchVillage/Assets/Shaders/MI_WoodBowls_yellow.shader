Shader "Unreal/MI_WoodBowls_yellow"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_WoodBowls_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_WoodBowls_BMask", 2D ) = "white" {}
		Material_Texture2D_2( "T_WoodBowls_ORMMask", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_WoodBowls_yellow.hlsl"
