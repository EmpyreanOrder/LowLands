Shader "Unreal/MM_RoofPlank"
{
    Properties
    {
		...
		Material_Texture2D_1( "BaseColor-crackMask(A)", 2D ) = "white" {}
		Material_Texture2D_2( "Mask(Dirt-Leak-Moss-AO)", 2D ) = "white" {}
		Material_Texture2D_3( "T_Moss_B", 2D ) = "white" {}
		Material_Texture2D_4( "T_PLank_trimSheet_Mask", 2D ) = "white" {}
