...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.135417,0.135417,0.135417,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.135417,0.135417,0.135417,0.992000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.892423,0.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = (Material.PreshaderBuffer[3].xyz * ((MaterialFloat3)Local3.r));
	MaterialFloat Local6 = (Local3.r * Material.PreshaderBuffer[4].x);
