Shader "Unreal/MI_PlankTrim_Zmoss"
{
    Properties
    {
		...
		Material_Texture2D_0( "WoodTiling_Normals", 2D ) = "white" {}
		Material_Texture2D_1( "Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Mask(Paint-AO-Edge-Moss)", 2D ) = "white" {}
		Material_Texture2D_3( "T_MossyBeech_N", 2D ) = "white" {}
		Material_Texture2D_4( "Wood_TilingColor", 2D ) = "white" {}
		Material_Texture2D_5( "Plank_TrimSheet_Color", 2D ) = "white" {}
		Material_Texture2D_6( "T_Moss_B", 2D ) = "white" {}
		Material_Texture2D_7( "T_Graywood_ORM", 2D ) = "white" {}
		Material_Texture2D_8( "T_Cloud3", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_PlankTrim_Zmoss.hlsl"
