...
namespace TRS.CaptureTool
{
    public static class ScreenExtensions
    {
        ...
        public static Resolution CurrentResolution()
        {
            ...
            return new Resolution { width = (int)size.x, height = (int)size.y, refreshRateRatio = Screen.currentResolution.refreshRateRatio };
#else
            return new Resolution { width = Screen.width, height = Screen.height, refreshRateRatio = Screen.currentResolution.refreshRateRatio };
#endif
#else
#if UNITY_EDITOR
            Vector2 size = GameView.CurrentSize();
