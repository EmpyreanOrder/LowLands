...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,0.880238,0.364583,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,0.880238,0.364583,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.500000,0.500000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,-10.000000,0.700000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local10 = lerp(Local8,((MaterialFloat3)Local9),Material.PreshaderBuffer[3].w);
